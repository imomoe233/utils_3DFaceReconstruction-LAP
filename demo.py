...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', default='E:\code_xwd\dataset\FF++/valid_ori/fake', type=str, help='Path to the directory containing input images')
    parser.add_argument('--result', default='E:\code_xwd\dataset\FF++/valid_lap/fake', type=str, help='Path to the directory for saving results')
    ...
    for im_path, filename in image_info_list:
        ...
        face2.save(f'E:\code_xwd\dataset\FF++/valid_1024/fake/{filename[:-4]}.jpg')
